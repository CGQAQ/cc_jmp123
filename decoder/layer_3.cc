...
void LayerIII::antialias(int gr, int ch,
                         const std::array<float, 32 * 18>& xrch) {
  auto  xr = xrch;
  int   i, maxidx;
  float bu, bd;
...
void LayerIII::imdct12(const std::array<float, 32 * 18>& xrch,
...
void LayerIII::imdct36(const std::array<float, 32 * 18>& xrch,
